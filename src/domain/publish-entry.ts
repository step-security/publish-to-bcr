...
export class PublishEntryService {
  ...
  public async publish(
    ...
    const pullNumber = await this.bcrGitHubClient.createPullRequest(
      ...
      `\
:warning: The Publish to BCR GitHub app will be discontinued after June 30, 2026. Please migrate to the GitHub Actions [reusable workflow](https://github.com/step-security/publish-to-bcr?tab=readme-ov-file#setup) before then.
