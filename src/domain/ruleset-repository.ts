...
import {
  SourceTemplate,
  SourceTemplateError as _InvalidSourceTemplateError,
...
Did you forget to add them to your ruleset repository? See instructions here: https://github.com/step-security/publish-to-bcr/blob/main/templates`
    );
  }
}
